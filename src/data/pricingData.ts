...
const rawMaterials: { name: string; size: string; pricePerM: number; markup: number; materialGroupIds: string[]; isFavorite: boolean }[] = [
  { name: '18PT White C2S Digital Cover - Tango', size: '13x19', pricePerM: 198.30, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: '20# Exact Color Multipurpose', size: '8.5x11', pricePerM: 18.73, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: '65# Colored Cover Astrobrights', size: '8.5x11', pricePerM: 56.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: '80# Classic Linen Text', size: '23x35', pricePerM: 357.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Chipboard Point #90 Item 073630', size: '12x18', pricePerM: 120.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss Cover 100# 13x19', size: '26x40', pricePerM: 360.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss Cover 100# 26x40', size: '13x19', pricePerM: 118.75, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss Cover 130# 13x19', size: '26x40', pricePerM: 67.26, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss Cover 130# WHITE 26x40 - McGregor', size: '13x19', pricePerM: 102.60, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss Cover 80# 13x19', size: '13x19', pricePerM: 65.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss Text 100# 13x19', size: '13x19', pricePerM: 56.18, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss Text 80# 13x19', size: '13x19', pricePerM: 128.25, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Matte 100# Cover 13x19', size: '13x19', pricePerM: 70.20, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Matte 100# Text 13x19', size: '12x19', pricePerM: 720.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Mohawk Superfine White Smooth Finish 150# Cover', size: '19x13', pricePerM: 95.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Satin 80# Cover 19x13 - Coronet Paper', size: '13x19', pricePerM: 75.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Satin Text 100# 13x19', size: '13x19', pricePerM: 196.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Uncoated Accent Cover 120# Opaque Smooth', size: '13x19', pricePerM: 342.90, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Uncoated Cougar Cover 130# Super Smooth', size: '13x19', pricePerM: 167.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Uncoated Opaque Cover 130# 13x19', size: '13x19', pricePerM: 102.40, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Uncoated Opaque Cover 80# 13x19', size: '8.5x11', pricePerM: 103.90, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'ZAPCO SECURITY GUARD+ BLUE(VD)', size: '8.5x11', pricePerM: 10.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: '20# Bond White Multiuse 067333', size: '11x17', pricePerM: 18.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: '20# Bond White QuickCopy 066000', size: '8.5x11', pricePerM: 13.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: '20# Colored Bond Earthchoice Colors (500ct)', size: '11x17', pricePerM: 26.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: '20# Colored Bond Earthchoice Colors (250ct)', size: '11x17', pricePerM: 57.27, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'NCR 2 Part 11x17', size: '11x17', pricePerM: 66.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'NCR 4 Part 8.5x11', size: '8.5x11', pricePerM: 18.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Laser House Sheet 60# Accent 068543', size: '12x18', pricePerM: 38.75, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Laser House Sheet 60# 11x17', size: '11x17', pricePerM: 23.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: '60# Offset White Husky 065990', size: '13x19', pricePerM: 59.60, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: '60# Offset White Text Smooth Husky Digital 068794', size: '12x18', pricePerM: 52.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Linen 100# Cover Sundance 063135', size: '12x18', pricePerM: 332.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Uncoated 80# Cover 12x18', size: '12x18', pricePerM: 89.10, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Uncoated 100# Cover Lynx N45715', size: '12x18', pricePerM: 110.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Uncoated 120# Cover Lynx 068823', size: '12x18', pricePerM: 140.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss 80# Gloss Text 12x18', size: '12x18', pricePerM: 59.80, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss 100# Gloss Text 12x18', size: '12x18', pricePerM: 59.80, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss 80# Cover 12x18', size: '12x18', pricePerM: 89.10, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss 100# Cover Blazer N64750', size: '12x18', pricePerM: 85.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Gloss 130# Cover Blazer 065024', size: '12x18', pricePerM: 109.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Satin 110# Cover Blazer 064932', size: '12x18', pricePerM: 94.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: '60# Self-Adhesive Gloss Starboard 092512 12x18', size: '12x18', pricePerM: 350.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: '60# Self-Adhesive Gloss Starboard 092512 8.5x11', size: '8.5x11', pricePerM: 210.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'NCR 2 Part 8.5x11', size: '8.5x11', pricePerM: 17.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'NCR 3 Part 11x17', size: '11x17', pricePerM: 69.93, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'NCR 3 Part 8.5x11', size: '8.5x11', pricePerM: 19.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Acetate Front Cover', size: '8.5x11', pricePerM: 200.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Back Vinyl Covers (Blue or Black)', size: '8.5x11', pricePerM: 300.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
  { name: 'Tabs Our Stock', size: '8.5x11', pricePerM: 80.00, markup: 70, materialGroupIds: ['mg1'], isFavorite: false },
];
